...
A diferencia de las otras dos ramas, RBCD **sí tiene una señal escribible y de alta fidelidad**: la escritura del atributo. La detección —[[Escritura del atributo de delegación RBCD]]— ancla en `4662` sobre ese atributo, y es de las de mejor fidelidad de AD, análoga a la de DCSync. La telemetría (`4662`) ya existe y se consume; esta rama es la que cierra el ciclo rojo↔azul de la delegación, mientras que las otras dos quedan como huecos declarados en [[MOC - Active Directory]].
