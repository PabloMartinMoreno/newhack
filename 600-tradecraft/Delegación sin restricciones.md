...
La detección natural es la anomalía de que una cuenta de alto valor se autentique a un host con delegación —lo cubre parcialmente [[Autenticación NTLM donde el dominio usa Kerberos]] cuando la coacción usa NTLM—, pero la señal específica de delegación sin restricciones no tiene detección propia escrita. Es un hueco declarado en [[MOC - Active Directory]]: la telemetría existe (4624/4768), falta la regla que ancle en "objeto sensible autenticándose a host con `TRUSTED_FOR_DELEGATION`".
