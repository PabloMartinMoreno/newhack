...
Esto es brute en capa **DNS**: encuentra nombres que **resuelven**. El fuzzing con `ffuf`/`gobuster` (subdominios y vhosts, con la distinción de capa) está en [[Fuzzing de subdominios y vhosts - matriz de referencia]].
