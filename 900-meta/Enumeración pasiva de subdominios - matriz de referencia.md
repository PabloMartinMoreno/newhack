...
> **Pasiva = no se toca la infra del objetivo**: todo sale de fuentes de terceros (OSINT). Sin ruido, ideal para recon externo y bug bounty. El brute **activo** (que sí consulta al DNS del objetivo) vive en [[DNS - matriz de referencia]]. El brute con fuzzers (ffuf/gobuster) de subdominios y vhosts está en [[Fuzzing de subdominios y vhosts - matriz de referencia]]. Criterio de recon en [[MOC - Reconocimiento de red]].
