...
- **Cheatsheets** — 123 matrices: 83 web, 10 AD (incluye [[SMB - matriz de referencia]]), 4 azules, 22 de red (nmap, rustscan, masscan, sondeos, [[DNS - matriz de referencia]], [[SMTP - matriz de referencia]], [[IMAP y POP3 - matriz de referencia]], [[SNMP - matriz de referencia]], [[MySQL - matriz de referencia]], [[MSSQL - matriz de referencia]], [[Oracle TNS - matriz de referencia]], [[IPMI - matriz de referencia]], [[SSH - matriz de referencia]], [[rsync - matriz de referencia]], [[R-services - matriz de referencia]], [[RDP - matriz de referencia]], [[WinRM - matriz de referencia]], [[WMI - matriz de referencia]], [[xfreerdp - matriz de referencia]], [[Enumeración pasiva de subdominios - matriz de referencia]], [[Footprinting pasivo - matriz de referencia]], [[Descubrimiento de virtual hosts - matriz de referencia]]), 4 de post-explotación (transferencia, exfiltración, [[FTP - matriz de referencia]], [[NFS - matriz de referencia]]), más [[XML de escaneo a HTML]], que no es matriz. Indexadas desde el MOC de su dominio
