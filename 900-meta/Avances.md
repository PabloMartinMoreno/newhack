...
- **Cheatsheets** — 109 matrices: 83 web, 10 AD (incluye [[SMB - matriz de referencia]]), 4 azules, 8 de red (nmap, rustscan, masscan, sondeos, [[DNS - matriz de referencia]], [[SMTP - matriz de referencia]], [[IMAP y POP3 - matriz de referencia]], [[SNMP - matriz de referencia]]), 4 de post-explotación (transferencia, exfiltración, [[FTP - matriz de referencia]], [[NFS - matriz de referencia]]), más [[XML de escaneo a HTML]], que no es matriz. Indexadas desde el MOC de su dominio
